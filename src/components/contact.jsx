...
import RESUME from '../assets/Resume_Javier-Nauvel-Sulthoni.pdf'
    ...
    return (
        <section name='contact' className='w-full h-screen grid items-center bg-slate-50 dark:bg-slate-950 p-4 border-b border-slate-800 transition-all duration-700'>
            ...
            <div className='__hide flex flex-col items-center mx-auto max-w-[1000px] w-full'>
                <p className='text-4xl font-bold inline border-b-4 border-sky-400 text-zinc-950 dark:text-sky-50'>Let's collaborate!</p>
                ...
                <a href={RESUME} target="_blank" className='sm:hidden text-zinc-950 dark:text-sky-50 group border-2 px-6 py-2 my-2 flex items-center justify-center w-[200px] hover:bg-slate-50 dark:hover:bg-slate-900 hover:border-sky-950 dark:hover:border-sky-50'><BsFillPersonLinesFill size={30}/></a>
            </div>    
        </section>
    );
}
