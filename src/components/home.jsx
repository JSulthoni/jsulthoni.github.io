    ...
    return (
        <section name='home' className='w-full h-screen bg-slate-50 dark:bg-slate-950 border-b border-slate-800 grid items-center transition-all duration-700'>
            ...
            <div className='__hide max-w-[1000px] w-[100%] mx-auto px-8 flex flex-col justify-center'>
                ...
                <h2 className='text-4xl sm:text-7xl font bold text-sky-400 dark:text-sky-500'>I'm a junior web developer</h2>
                <p className='text-zinc-950 dark:text-sky-50 py-4 max-w-700px text-base sm:text-3xl'>focusing in online shop, web applications, and responsive UI design.</p>
